    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-violet-50 border border-violet-100 text-violet-500 text-sm px-3.5 py-1.5 rounded-full mb-8">
          ...
          Automated Social Engagement Solutions
        </div>
        ...
        <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-slate-900">
          ...
          <br />
          <span className="text-violet-400 italic">Expand rapidly.</span>
        </h1>

        {/* Subheadline */}
        <p className="mt-7 text-gray-500 max-w-2xl mx-auto">
          Streamline your social media presence with an all-in-one platform to
          create, schedule, and automate engagement—backed by an intelligent
          assistant that drafts your captions and replies for you.
        </p>
        ...
        <div className="mt-7 flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            to="/login"
            className="bg-violet-500 text-white rounded-full font-medium hover:bg-violet-600 hover:shadow-[0_8px_24px_rgba(139,92,246,0.35)] inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto justify-center transition-all"
          >
        ...
        <p className="mt-5 text-xs text-gray-400">
          Free access guaranteed indefinitely, requiring no credit card
          verification.
        </p>
      </div>
